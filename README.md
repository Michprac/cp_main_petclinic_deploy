# Spring PetClinic Appp Deployment on GCP

Capstone Project from the Internship in Grid Dynamics.

Original Capstone Project repo is under the [link](https://github.com/mboguslawsk/cp_main_capstone_project).
